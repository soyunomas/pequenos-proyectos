...
## Corrección de recortes de insectos

Se sustituyen `assets/cockroach.webp` y `assets/wasp.webp`. La cucaracha elimina el borde inferior oscuro incorporado en el recorte previo y ahora tiene transparencia depurada, sin proyectar una raya fija; la sombra de contacto sigue generándose por separado en el canvas. La avispa utiliza una composición bilateral de alas, patas y abdomen, reorientada a vista superior con la cabeza hacia la parte superior del archivo. Se actualiza `creatureHeading` para que ambas especies avancen cabeza por delante en cualquier dirección; la araña conserva su orientación original. Se versionan las URLs de imágenes y módulo para evitar el antiguo WebP en caché. Las pruebas comprueban imágenes decodificables, esquinas transparentes, simetría de silueta y dirección.

## Versión 2.1 — bichos primero, maquillaje verde y hasta cinco caras

- El catálogo sitúa **Arañas, Cucarachas y Avispas** al principio. La aplicación abre con **Arañas por la cara al 100 %**; el regulador de bichos mantiene sus valores previos. «Restablecer» sigue volviendo a Normal.
- Face Landmarker 0.10.35 se configura con `numFaces: 5`. Se procesan hasta cinco rostros detectados; no se garantiza que todos sean detectables en cualquier encuadre, iluminación o dispositivo. Cada rostro recibe los efectos seleccionados, incluido el maquillaje y hasta cinco bichos **por rostro**.
- WebGL2 dibuja la cámara original y después aplica un recorte independiente por rostro con un máximo de 32 controles por pasada. Evita subir el número de uniformes a 160 y mantiene la fuente de textura original en cada pasada. Los rostros muy solapados pueden mostrar límites entre pasadas. Se asocian fotogramas sucesivos por proximidad de la nariz para reducir saltos al cambiar el orden de caras devuelto por MediaPipe.
- **Maquillaje verde · ojos, pestañas y labios** agranda moderadamente ojos y labios mediante el shader; un canvas transparente añade sombra verde difuminada en los párpados, línea de ojos, pestañas dibujadas individualmente, pintalabios con el interior de la boca excluido y colorete difuso. Todo sigue los landmarks ya deformados. Es maquillaje digital dibujado sobre la textura real, **no una imagen fotográfica ni un SVG**. Puede combinarse con las especies o con otros filtros.
- No se incluye un parche ocular: para cumplir un acabado fotorrealista haría falta un recurso de textura recortado con buen alfa y perspectiva, o una composición 3D, más sombra dinámica y oclusión. No se sustituye por un SVG plano.

**Pruebas previstas:** las suites de lógica y Playwright comprueban catálogo, inicio, cálculos multirrostro, recortes, mezcla, persistencia y navegación. La precisión visual, el rendimiento con cinco caras y la estética del maquillaje requieren webcam y prueba física; las verificaciones sintéticas no acreditan esas condiciones.
