...
public final class ScheduleModels {
    ...
    public static final String AFTERNOON = "T";

    public static final class ShiftConfig {
        public String id, label;
        public boolean enabled;
        public LocalTime start, end;
        public int breakAfterSession, breakMinutes;
        public ShiftConfig(String id, String label, boolean enabled, LocalTime start, LocalTime end, int breakAfterSession, int breakMinutes) {
            this.id=id; this.label=label; this.enabled=enabled; this.start=start; this.end=end; this.breakAfterSession=breakAfterSession; this.breakMinutes=breakMinutes;
        }
    ...
    public static final class Subject {
        ...
        public Subject copy() { return new Subject(code,name); }
    }
    ...
    public static final class Slot {
        public final String shiftId, shiftLabel;
        public final LocalTime start,end;
        public final boolean isBreak;
        public final int sessionIndex;
        public Slot(String shiftId,String shiftLabel,LocalTime start,LocalTime end,boolean isBreak,int sessionIndex){this.shiftId=shiftId;this.shiftLabel=shiftLabel;this.start=start;this.end=end;this.isBreak=isBreak;this.sessionIndex=sessionIndex;}
        public String identity(){return shiftId+":"+(isBreak?"B":"S"+sessionIndex);}
    }
    public static final class SlotRef {
        public final int dayIndex; public final Slot slot; public final String code;
        public SlotRef(int dayIndex,Slot slot,String code){this.dayIndex=dayIndex;this.slot=slot;this.code=code==null?"":code;}
    }
    public static final class NowNext {
        public final SlotRef current,next;
        public NowNext(SlotRef current,SlotRef next){this.current=current;this.next=next;}
    }
}
