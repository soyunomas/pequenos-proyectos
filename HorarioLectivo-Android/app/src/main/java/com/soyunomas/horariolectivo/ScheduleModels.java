...
public final class ScheduleModels {
    ...
    public static final String MORNING="M", AFTERNOON="T", NIGHT="N", BETWEEN="E", BETWEEN_NIGHT="EN";
    public static final String TYPE_LECTIVA="LECTIVA", TYPE_COMPLEMENTARIA="COMPLEMENTARIA";

    public static boolean isBetweenShift(String id){return BETWEEN.equals(id)||BETWEEN_NIGHT.equals(id);}
